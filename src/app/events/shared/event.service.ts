...
// and it's important that you don't forget to put parentheses on the end of here like this.
...
export class EventService {
  ...
  updateEvent(event: any) {
    let index = EVENTS.findIndex(x => x.id = event.id) // finding the existing event in the array and replace it for now
    EVENTS[index] = event
