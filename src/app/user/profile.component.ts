...
export class ProfileComponent implements OnInit {
    ...
    constructor(private authService:AuthService, 
                ...
                @Inject(TOASTR_TOKEN) private toastr: Toastr // the decorator is applied to the 'toastr' parameter. even though we are giving a type of toastr, the way Angular 2 is goingto look it up in the dependency injection registry is using the TOKEN because it is given the inject decorator and passed in that token
                ) {
